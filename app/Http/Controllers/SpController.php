...
class SpController extends Controller
{
    ...
    /**
     * Menjaga cache daftar SP tetap cepat tanpa menyajikan angka lama setelah mutasi.
     * Cache statistik lama dibiarkan kedaluwarsa sendiri agar invalidasi tetap murah.
     */
    private function invalidateSpIndexCaches(): void
    {
        ...
        Cache::forever('sp:index-stats:version', (string) Str::uuid());
    }
    ...
    private function addFormUjiKelayakanPenyediaEksternal(
        ...
        $addCheckOption = function ($cell, bool $checked, callable $textBuilder) use ($boxHolderStyle, $checkFont, $pCheck) {

...
═══════════════════════════════════════ */
        (function () {
            ...
            function toast(msg, type) { var dk = document.documentElement.classList.contains('dark'); var txt = String(msg || '').toLowerCase(); var important = txt.indexOf('too many') !== -1 || txt.indexOf('terlalu banyak') !== -1 || txt.indexOf('attempt') !== -1 || txt.indexOf('dikunci') !== -1 || txt.indexOf('coba lagi') !== -1; if (typeof Swal !== 'undefined') Swal.fire({ toast: true, position: 'top-end', icon: type || 'info', title: msg, showConfirmButton: important, confirmButtonText: 'Mengerti', timer: important ? 12000 : (type === 'error' || type === 'warning' ? 6500 : 3000), timerProgressBar: true, background: dk ? '#1f2937' : '#fff', color: dk ? '#f3f4f6' : '#111827' }); else alert(msg) }
